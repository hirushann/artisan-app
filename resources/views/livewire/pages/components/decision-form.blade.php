...
<div>
    <div>
        <div class="py-8 px-4 mx-auto lg:py-16" x-data="{ mainType: 'personal', subType: '' }">
                ...
                <div class="col-span-3">
                    <ul class="grid w-full gap-6 md:grid-cols-4">
                        <li x-show="mainType === 'personal'">
                            <input type="radio" x-model="subType" id="buy-a-car" name="subPurpose"
                                wire:model="subPurpose" value="buy-a-car" class="hidden peer" required />
                            <label for="buy-a-car"
                        ...
                        <li x-show="mainType === 'personal'">
                            <input type="radio" x-model="subType" id="buy-a-house" name="subPurpose"
                                wire:model="subPurpose" value="buy-a-house" class="hidden peer">
                            <label for="buy-a-house"
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-orange-400 peer-checked:border-orange-400 dark:peer-checked:border-orange-400 peer-checked:text-orange-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <div class="block">
                                    <div class="w-full text-lg font-semibold">Buy a house</div>
                                    <div class="w-full text-sm text-gray-400">Good for long-term personal investment.
                                    </div>
                                </div>
                            </label>
                        </li>
                        <li x-show="mainType === 'personal'">
                            <input type="radio" id="new-mobile" x-model="subType" name="subPurpose"
                                wire:model="subPurpose" value="new-mobile" class="hidden peer">
                        ...
                        <li x-show="mainType === 'personal'">
                            ...
                            <label for="new-internet-line"
                                ...
                                <div class="block">
                                    ...
                                    <div class="w-full text-sm text-gray-400">Picking the best ISP for home internet.
                                    </div>
                                </div>
                            </label>
                        </li>
                        <li x-show="mainType === 'personal'">
                            <input type="radio" id="new-pet" name="subPurpose" wire:model="subPurpose"
                                x-model="subType" value="new-pet" class="hidden peer">
                            <label for="new-pet"
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-orange-400 peer-checked:border-orange-400 dark:peer-checked:border-orange-400 peer-checked:text-orange-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <div class="block">
                        ...
                        <li x-show="mainType === 'personal'">
                            <input type="radio" id="new-buys" name="subPurpose" wire:model="subPurpose"
                                x-model="subType" value="new-buys" class="hidden peer">
                            <label for="new-buys"
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-orange-400 peer-checked:border-orange-400 dark:peer-checked:border-orange-400 peer-checked:text-orange-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <div class="block">
                                    <div class="w-full text-lg font-semibold">Buy something new</div>
                                    <div class="w-full text-sm text-gray-400">Selecting a gadget, appliance, or
                                        accessory.
                                    </div>
                                </div>
                            </label>
                        ...
                        <li x-show="mainType === 'business'">
                            ...
                            <label for="business-start"
                                ...
                                <div class="block w-full">
                                    ...
                                    <div class="w-full text-sm text-gray-400">Planning to launch a new business
                                        venture.
                                    </div>
                                </div>
                            </label>
                        ...
                        <li x-show="mainType === 'business'">
                            ...
                            <label for="hire-employee"
                                ...
                                <div class="block w-full">
                                    ...
                                    <div class="w-full text-sm text-gray-400">Selecting the best candidate for a job.
                                    </div>
                                </div>
                            </label>
                        </li>
                        <li x-show="mainType === 'business'">
                            ...
                            <label for="invest-in-tools"
                                ...
                                <div class="block w-full">
                                    ...
                                    <div class="w-full text-sm text-gray-400">Choosing equipment for workplace
                                        efficiency.
                                    </div>
                                </div>
                            </label>
                        ...
                        <li x-show="mainType === 'business'">
                            <input type="radio" id="office-space-upgrade" name="subPurpose"
                                wire:model="subPurpose" x-model="subType" value="office-space-upgrade"
                                class="hidden peer">
                            <label for="office-space-upgrade"
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-orange-400 peer-checked:border-orange-400 dark:peer-checked:border-orange-400 peer-checked:text-orange-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <div class="block w-full">
                                    <div class="w-full text-lg font-semibold mb-2">Upgrade office space</div>
                                    <div class="w-full text-sm text-gray-400">Expanding or renovating office
                                        facilities.
                                    </div>
                                </div>
                            </label>
                        ...
                        <li x-show="mainType === 'business'">
                            ...
                            <label for="new-business-sw"
                                ...
                                <div class="block w-full">
                                    ...
                                    <div class="w-full text-sm text-gray-400">Selecting the best software for
                                        operations.
                                    </div>
                                </div>
                            </label>
                        ...
                        <li x-show="mainType === 'business'">
                            ...
                            <label for="company-vehicle"
                                ...
                                <div class="block w-full">
                                    ...
                                    <div class="w-full text-sm text-gray-400">Choosing a vehicle for work-related
                                        needs.
                                    </div>
                                </div>
                            </label>
                        ...
                        <li x-show="mainType === 'family'">
                            ...
                            <label for="family-vehicle"
                                ...
                                <div class="block w-full">
                                    ...
                                    <div class="w-full text-sm text-gray-400">Picking a safe car for family trips.
                                    </div>
                                </div>
                            </label>
                        </li>
                        ...
                        <li x-show="mainType === 'family'">
                            ...
                            <label for="enroll-to-school"
                                ...
                                <div class="block w-full">
                                    ...
                                    <div class="w-full text-sm text-gray-400">Deciding on the best school for kids.
                                    </div>
                                </div>
                            </label>
                        </li>
                        <li x-show="mainType === 'family'">
                            <input type="radio" id="home-renno" name="subPurpose" wire:model="subPurpose"
                                x-model="subType" value="home-renno" class="hidden peer">
                            <label for="home-renno"
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-orange-400 peer-checked:border-orange-400 dark:peer-checked:border-orange-400 peer-checked:text-orange-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <div class="block w-full">
                                    <div class="w-full text-lg font-semibold mb-2">Home renovation</div>
                                    <div class="w-full text-sm text-gray-400">Upgrading or fixing parts of the home.
                                    </div>
                                </div>
                            </label>
                        </li>
                        <li x-show="mainType === 'family'">
                            <input type="radio" id="adopt-pet" name="subPurpose" wire:model="subPurpose"
                                x-model="subType" value="adopt-pet" class="hidden peer">
                            <label for="adopt-pet"
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-orange-400 peer-checked:border-orange-400 dark:peer-checked:border-orange-400 peer-checked:text-orange-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <div class="block w-full">
                                    <div class="w-full text-lg font-semibold mb-2">Adopt a pet</div>
                                    <div class="w-full text-sm text-gray-400">Choosing the right pet for the family.
                                    </div>
                                </div>
                            </label>
                        </li>
                        <li x-show="mainType === 'family'">
                            <input type="radio" id="new-gadget" name="subPurpose" wire:model="subPurpose"
                                x-model="subType" value="new-gadget" class="hidden peer">
                            <label for="new-gadget"
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-orange-400 peer-checked:border-orange-400 dark:peer-checked:border-orange-400 peer-checked:text-orange-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <div class="block w-full">
                                    <div class="w-full text-lg font-semibold mb-2">New family gadget</div>
                                    <div class="w-full text-sm text-gray-400">Buying a device for shared use at home.
                                    </div>
                                </div>
                            </label>
                        </li>
            ...
            <form action="post" x-show="subType !== ''" x-data="{
                items: $wire.entangle('options').live,
                addItem() {
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-10 mt-10 items-center">
                    ...
                    <div
                        ...
                        <div>
                            <h3 class="mb-5 text-3xl mt-5 text-center text-gray-500 font-bold dark:text-gray-300">Let's
                                get down to the available options?</h3>
                            @error('options')
                                <span class="error">{{ $message }}</span>
                            @enderror
                            <div>
                                <template x-for="(item, index) in items" x-bind:key="index">
                                    <div class="mb-5 relative">
                                        <div class="relative flex py-5 items-center">
                                            <span class="flex-shrink mr-4 text-2xl font-black text-orange-400">Option
                                                .<span x-text="index + 1"
                                                    class="text-slate-500 font-bold dark:text-white"></span></span>
                                            <div class="flex-grow border-t border-gray-400"></div>
                                            <x-mini-button x-show="items.length > 2" rounded icon="trash"
                                                x-on:click="items.splice(index, 1)" flat negative
                                        ...
                                        <div class="flex gap-5 w-full">
                                            <div class="w-full flex flex-col gap-3">
                                                <h4 class="text-base font-medium text-gray-900 dark:text-gray-400">Pros
                                                </h4>
                                            ...
                                            <div class="w-full flex flex-col gap-3">
                                                <h4 class="text-base font-medium text-gray-900 dark:text-gray-400">Cons
                                                </h4>
                                ...
                                <div class="flex flex-col gap-3 my-5">
                                    <x-radio id="detailed-report" rounded="base" xl label="Detailed Report"
                                        wire:model="reportType" value="detailed" />
                                    <x-radio id="summarized-report" rounded="base" xl label="Summarized Report"
                                        wire:model="reportType" value="summary" />
                                </div>

                                <div class="flex gap-3">
                                    <x-button info label="Let AI to make the decision.." lg wire:click="saveForm"
                                        rounded="lg" class="w-full" />
                                    <x-button rounded="lg" warning label="Add Option" lg x-on:click="addItem()"
                                        class="w-full" />
                                </div>
                            </div>
                        </div>
