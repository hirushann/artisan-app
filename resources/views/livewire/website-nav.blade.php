<nav class="py-4 px-6 sm:px-8 w-full">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            @auth
                <a href="{{ route('dashboard') }}" class="bg-decisioner-orange hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                    Dashboard
                </a>
            @else
                ...
                <a href="{{ route('register') }}" class="bg-decisioner-orange hover:bg-orange-600 text-white px-4 py-2 rounded-lg transition-colors">
                    Get Started
                </a>
            @endauth
        </div>
    ...
    @if ($isMenuOpen)
        <div class="md:hidden absolute top-16 left-0 right-0 bg-white z-50 border-b border-gray-200 animate-fade-in">
            <div class="flex flex-col space-y-4 p-6">
                ...
                @auth
                    <a href="{{ route('dashboard') }}" class="bg-decisioner-orange hover:bg-orange-600 text-white px-4 py-2 rounded-lg text-center font-medium transition-colors">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" class="text-decisioner-charcoal font-medium hover:text-decisioner-orange transition-colors flex items-center gap-1">
                    ...
                    <a href="{{ route('register') }}" class="bg-decisioner-orange hover:bg-orange-600 text-white px-4 py-2 rounded-lg text-center transition-colors">
                        Get Started
                    </a>
                @endauth
            </div>
