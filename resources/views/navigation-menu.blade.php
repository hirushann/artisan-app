<nav x-data="{ mobileMenuOpen: false }" class="bg-white dark:bg-gray-800 border-b border-l border-gray-100 dark:border-gray-600">
                        ...
                        <div class="relative z-50" x-data="{ open: false }" @click.away="open = false" @close.stop="open = false">
                            <div @click="open = ! open">
                                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                    <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition cursor-pointer">
                            ...
                            <div x-show="open"
                                 ...
                                 class="absolute right-0 z-50 mt-2 w-48 rounded-md shadow-lg origin-top-right bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 focus:outline-none"
                                 style="display: none;">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="mobileMenuOpen = ! mobileMenuOpen"
                    ...
                    <svg class="size-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                        ...
                        <path :class="{ 'hidden': !mobileMenuOpen, 'inline-flex': mobileMenuOpen }" class="hidden" stroke-linecap="round"
